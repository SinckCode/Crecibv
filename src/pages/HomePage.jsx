...
const HomePage = () => {
  ...
  return (
    <div className="home-page">
      ...
      <section id="carousel" ref={carouselRef} className={`section ${carouselInView ? 'visible' : ''}`}>
        <Carousel />
      </section>

      <section id="services" ref={servicesRef} className={`section ${servicesInView ? 'visible' : ''}`}>
        <ServicesPage />
      </section>
