...
const HomePage = () => {
  ...
  const { ref: donativosRef, inView: donativosInView } = useInView({
    triggerOnce: true,
    threshold: 0.1,
  });
  ...
  return (
    <div className="home-page">
      ...
      <section
        id="about-us2"
        ref={aboutRef2}
        className={`section ${aboutInView2 ? 'visible' : ''}`}
      >
        <AboutUs2 />
      </section>
      ...
      <section
        id="about-us3"
        ref={aboutRef3}
        className={`section ${aboutInView3 ? 'visible' : ''}`}
      >
        <AboutUs3 />
      </section>
      ...
      <section
        id="services"
        ref={carouselRef}
        className={`section ${carouselInView ? 'visible' : ''}`}
      >
        <Carousel />
      </section>
      ...
      <section
        id="donativos"
        ref={donativosRef}
        className={`section ${donativosInView ? 'visible' : ''}`}
      >
        <DonativoSection />
      </section>
      ...
      <section
        id="contact"
        ref={contactRef}
        className={`section ${contactInView ? 'visible' : ''}`}
      >
        <ContactPage />
      </section>
      ...
      <section
        id="location"
        ref={locationRef}
        className={`section ${locationInView ? 'visible' : ''}`}
      >
        <LocationPage />
      </section>
    </div>
